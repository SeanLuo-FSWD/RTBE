...
var AuthController = /** @class */ (function () {
    function AuthController(_authService) {
        var _this = this;
        this._authService = _authService;
        this.path = "/auth";
        this.router = (0, express_1.Router)();
        this.authenticate = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                res.status(200).send(req.user);
                return [2 /*return*/];
            });
        }); };
        this.googleLoginRedirect = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this._authService.googleLoginRedirect(req, res, next);
                return [2 /*return*/];
            });
        }); };
        this.googleLogin = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
